...
int main(int argc, char ** argv) {
    ...
    for (int i = 1; i < argc; i++) {
        ...
        } else if (strcmp(argv[i], "-coopmat") == 0 || strcmp(argv[i], "--coopmat") == 0) {
            if (i + 1 < argc) {
                const char * value = argv[++i];
                const int coopmat = atoi(value);
                if (coopmat < 0 || coopmat > 3 || strcmp(value, std::to_string(coopmat).c_str()) != 0) {
                    usage(argv);
                    return 1;
                }
        ...
        } else if (strcmp(argv[i], "-vulkandebug") == 0 || strcmp(argv[i], "--vulkan-debug") == 0) {
            if (i + 1 < argc) {
                const char * value = argv[++i];
                if (strcmp(value, "1") == 0 || strcmp(value, "on") == 0 || strcmp(value, "true") == 0 || strcmp(value, "yes") == 0) {
                    set_env("GGML_VULKAN_DEBUG", "1");
                } else if (strcmp(value, "0") == 0 || strcmp(value, "off") == 0 || strcmp(value, "false") == 0 || strcmp(value, "no") == 0) {
                    set_env("GGML_VULKAN_DEBUG", "0");
                } else {
                    usage(argv);
                    return 1;
                }
